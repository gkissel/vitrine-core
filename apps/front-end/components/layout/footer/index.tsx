...
const companyEmail = process.env.SITE_COMPANY_EMAIL?.trim() || "ervamate@ervinha.com.br";
const companyPhone = process.env.SITE_COMPANY_PHONE?.trim() || "(54) 3254-1132";
const facebookHref = process.env.SOCIAL_FACEBOOK?.trim() || "https://www.facebook.com/?locale=pt_BR";
const instagramHref = process.env.SOCIAL_INSTAGRAM?.trim() || "https://www.instagram.com/";
				...
				<div className="border-t border-gray-200 py-8 md:py-20">
					<div className="md:hidden">
						<div className="space-y-10 text-left">
							...
							<section>
								<h3 className="text-[15px] font-bold text-gray-900">Redes Sociais</h3>
								<div className="mt-5">
									<div className="flex items-center gap-5">
										...
										{instagramHref ? (
											...
											<span className="inline-flex text-black" title="Instagram">
												<FaInstagram className="size-5" />
											</span>
										)}
									</div>
							...
							<section>
								...
								<address className="mt-5 not-italic text-[15px] leading-7 text-gray-900">
									<div className="flex items-start gap-3">
										...
										<a href={`mailto:${companyEmail}`} className="transition-colors hover:text-gray-700">
											{companyEmail}
										</a>
									</div>
