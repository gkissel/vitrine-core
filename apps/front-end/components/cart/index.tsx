  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={openCart}
        className="group focus-visible:outline-brand mr-2 flex cursor-pointer items-center rounded-md p-2 focus-visible:outline-2 focus-visible:outline-offset-2"
      >
        <ShoppingCartIcon
          aria-hidden="true"
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="ml-3 flex h-7 items-center">
                        <button
                          type="button"
                          onClick={closeCart}
                          className="focus-visible:outline-brand relative -m-2 cursor-pointer rounded-md p-2 text-gray-400 hover:text-gray-500 focus-visible:outline-2 focus-visible:outline-offset-2"
                        >
                                      ...
                                      <div className="flex flex-1 items-end justify-between text-sm">
                                        <div className="ml-0 flex h-7 flex-row items-center rounded-full border border-gray-200 bg-white">
                                          <EditItemQuantityButton
                                            ...
                                            size="xs"
                                          />
                                          <span className="text-brand relative z-10 mx-1 w-8 px-0.5 text-center text-sm leading-none font-semibold tabular-nums select-none">
                                            {item.quantity}
                                          </span>
                                          <EditItemQuantityButton
                                            item={item}
...
function CheckoutButton() {
  ...
  return (
    <button
      className="bg-brand hover:bg-brand-600 focus-visible:ring-brand-500 flex w-full cursor-pointer items-center justify-center rounded-md px-6 py-3 text-base font-medium text-white shadow-xs focus:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500"
      type="submit"
      disabled={pending}
    >
