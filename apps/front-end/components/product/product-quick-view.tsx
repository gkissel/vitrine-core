...
export function ProductQuickView({ product, wishlistState, open, onClose }: ProductQuickViewProps) {
													...
													<fieldset aria-label="Choose a color" className="mt-2">
														<div className="flex items-center gap-x-3">
															{colorOption.values.map((colorName) => {
																...
																const isAvailable = isVariantAvailable("color", colorName);
																return (
																	<div
																		key={colorName}
																		className={clsx(
											...
											<div className="mt-6 flex items-start gap-x-3">
												...
												{selectedVariantId && (
													<WishlistButton
														...
														isInWishlist={
															selectedVariantId === product.variants?.[0]?.id ? wishlistState?.isInWishlist : undefined
														}
														wishlistId={
															selectedVariantId === product.variants?.[0]?.id ? wishlistState?.wishlistId : undefined
														}
														wishlistItemId={
