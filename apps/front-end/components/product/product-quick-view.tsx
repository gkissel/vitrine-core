...
import { PLACEHOLDER_IMAGE_SRC, getColorHex } from "lib/utils";
                                ...
                                return (
                                  <label
                                    ...
                                    className={clsx(
                                      ...
                                      isSelected
                                        ? "border-primary-600 bg-brand text-white"
                      ...
                      <div className="mt-6 flex items-start gap-x-3">
                        <div className="flex-1">
                          <button
                            ...
                            className="bg-brand hover:bg-brand focus:ring-brand flex w-full cursor-pointer items-center justify-center rounded-md border border-transparent px-8 py-3 text-base font-medium text-white focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
                          >
                            {!selectedVariant?.availableForSale
                              ? "Sem estoque"
                              : isPending
