...
import { buildBreadcrumbJsonLd, buildProductJsonLd, JsonLdScript } from "lib/structured-data";
...
async function RelatedProducts({ productPromise }: { productPromise: Promise<Product | undefined> }) {
	...
	const transformedRelatedProducts = transformProductsToRelatedProducts(relatedProducts);

	return <RelatedProductsComponent products={transformedRelatedProducts} fullProducts={relatedProducts} />;
}
