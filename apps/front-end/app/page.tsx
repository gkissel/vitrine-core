...
export default async function HomePage() {
	...
	const firstCategoryProducts = allProducts.slice(0, 4).map(transformProductToTailwind);
	const secondCategoryProducts = allProducts.slice(4, 8).map(transformProductToTailwind);
	...
	return (
		<>
			...
			<MasonryFeatures
				title={
					<>
						Cultivada com cuidado, <span className="font-normal italic bg-[#9FBD3B33]">"com orgulho entregue"</span>{" "}
